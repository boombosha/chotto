...
//=========================================================================================================================================================================================//
  ...
  },
  {
    ...
    timestamp: '1757497524',
    header: 'Анна',
    text: 'Горы часто образуют протяженные цепи (хребты) или системы. Их характерными чертами являются высотная поясность (смена климата, растительности и животного мира с высотой), более суровые климатические условия и сложный рельеф.',
    backgroundColor: '#E6EE9C',
    subText: 'Анна',
    url:'https://imcdn.bolshayastrana.com/1200x628/BS_092905d87801c41ac91276d7a9da98a94f97a28d734f96682feff1e5d561bbec.jpeg',
    avatar:'https://placehold.jp/30/f1048e/ffffff/64x64.png?text=Ann',
  },
  {
    chatId: 6,
    ...
    direction: 'incoming',
    status: 'read',
    timestamp: '1757497525',
    header: 'Анна',
    text: 'Горы часто образуют протяженные цепи (хребты) или системы. Их характерными чертами являются высотная поясность (смена климата, растительности и животного мира с высотой), более суровые климатические условия и сложный рельеф.',
    backgroundColor: '#E6EE9C',
    subText: 'Анна',
    url:'https://sun9-79.userapi.com/s/v1/ig2/SHP8tV7yvtPSZIZXyN4jkycZoNWKGk5vbcXbEd47fVHnXMwCOphbKVrE-uPqZvk5ptaTxIExqm6sp6ocN-xinDoa.jpg?quality=95&as=20x500&from=bu&cs=20x0',
    avatar:'https://placehold.jp/30/f1048e/ffffff/64x64.png?text=Ann',
  },
  {
    chatId: 6,
  ...
  },
  {
    ...
    messageId: '621',
    type: "message.text",
    text: "Все идет по плану, скоро покажу результат",
    direction: 'outgoing',
    status: 'read',
    timestamp: '1756979201',
    header: 'Вы',
    subText: 'Вы',
  ...
  },
  {
    ...
    text: "Вот скриншот интерфейса",
    direction: 'outgoing',
    status: 'read',
    timestamp: '1756979301',
    header: 'Вы',
    subText: 'Вы',
  ...
  // Max Виктора
  {
    ...
    messageId: '625',
    type: "message.text",
    text: "Привет! Отправил тебе файлы по проекту в Max",
    direction: 'incoming',
    status: 'read',
    timestamp: '1756805101',
    header: 'Виктор',
    subText: 'Виктор',
  ...
  },
  {
    ...
    text: "Вот техническое задание",
    direction: 'incoming',
    status: 'read',
    timestamp: '1756805201',
    header: 'Виктор',
    subText: 'Виктор',
    backgroundColor: '#F3E5F5',
    avatar:'https://placehold.jp/30/336633/ffffff/64x64.png?text=VIK',
  },
  {
    ...
    messageId: '627',
    type: "message.text",
    text: "Спасибо! Изучу и отвечу завтра",
    direction: 'outgoing',
    status: 'received',
    timestamp: '1756805301',
    header: 'Вы',
    subText: 'Вы',
  ...
  },
  {
    ...
    messageId: '628',
    type: "message.text",
    text: "Есть вопросы по архитектуре?",
    direction: 'incoming',
    status: 'received',
    timestamp: '1756805401',
    header: 'Виктор',
    subText: 'Виктор',
  ...
  },
  {
    ...
    type: "message.image",
    url: "https://nationaltoday.com/wp-content/uploads/2022/05/Sun-Day--1200x834.jpg",
    text: "Схема архитектуры системы",
    direction: 'incoming',
    status: 'received',
    timestamp: '1756805501',
    header: 'Виктор',
    subText: 'Виктор',
...
2 мин
1.9K
Open source * Linux * Настройка Linux * Управление разработкой * Управление сообществом *

28 сентября 2025 года Линус Торвальдс представил первый стабильный релиз ядра Linux 6.17 под кодовым названием. Выпуск новой версии ядра Linux состоялся в соответствии с графиком, спустя два месяца после выхода предыдущей стабильной версии Linux 6.16 в июле. Новая версия станет ядром для Ubuntu 25.10, Fedora 43 и других дистрибутивов Linux, планируемых к выпуску в конце 2025 года. Релиз Linux 6.18 ожидается в конце 2025 года или начале 2026 года.

Исходный код Linux 6.17 доступен для загрузки на портале kernel.org. Коммит релиза ядра Linux 6.17 на GitHub и на Makefile (и на Git) от Линуса Торвальдса.

В Linux 6.17 принято 14 334 исправлений от 2118 разработчиков, размер патча — 46 МБ (изменения затронули 12 841 файлов, добавлено 646 654 строк кода, удалено 398 782 строк). В прошлом выпуске было 15 924 исправления от 2145 разработчиков, размер патча — 50 МБ. Около 43% всех представленных в 6.17 изменений связаны с драйверами устройств, примерно 12% изменений имеют отношение к обновлению кода, специфичного для аппаратных архитектур, 14% связано с сетевым стеком, 4% — с файловыми системами и 3% c внутренними подсистемами ядра.

Новая версия ядра Linux содержит большое количество изменений, обновлений и доработок, а также исправлений по ранее обнаруженным багам (Linux 6.17 changelog, LWN merge‑window summaries — part 1, part 2). В код проекта добавлена поддержка нового оборудования. В Linux 6.17 также появилось больше возможностей по работе с Rust для сборки ядра с использованием только стабильных функций этого языка программирования.

Среди наиболее заметных изменений:

- улучшенный контроль над средствами защиты от Spectre для x86 (Attack Vector Controls);
- поддержка установки патчей в режиме реального времени на 64-битных платформах Arm;
- отправка core-дампов через сокет AF_UNIX;
- лимитирование SCHED_EXT через cgroup;
- упрощённая настройка защиты от уязвимостей в CPU;
- сборка в Clang с инициализацией переменных в стеке;
- защита от подмены /proc, расширение подсистемы RV (Runtime Verification);
- ограничение сокетов AF_UNIX через AppArmor;
- ряд улучшений pidfd;
- стабилизацию графики Intel Panther Lake Xe3;
- улучшения графических драйверов Intel для Project Battlematrix;
- модуль DAMON_STAT со статистикой доступа к памяти;
- прекращение специальной поддержки однопроцессорных систем;
- начальная поддержка выполнения прокси-сервера;
- экспериментальная поддержка больших фолио в файловой системе Btrfs, повышение производительности Btrfs;
- системные вызовы file_getattr() и file_setattr();
- поддержка протокола управления перегрузкой DualPI2 (алгоритм контроля перегрузок TCP DualPI2);
- унификация однопроцессорных и многопроцессорных конфигураций в планировщике задач;
- поддержку основной версии Raspberry Pi RP1;
- драйвер Intel IPU7;
- улучшенную масштабируемость EXT4;
- различные улучшения для оптимизации и производительности, включая дополнения для драйвера AMD64 Error Detection And Correction (EDAC) и поддержка AMD Assignable Bandwidth Monitoring Counters (ABMC) в AMD EPYC.`,
    direction: 'incoming',
    status: 'received',
    timestamp: '1756805524',
    header: 'Виктор',
    subText: 'Виктор',
    backgroundColor: '#FCE4EC',
    avatar:'https://placehold.jp/30/336633/ffffff/64x64.png?text=VIK',
